...
const SendParcel = () => {
    ...
    return (
        <div>
            <h2 className="text-5xl font-bold text-center p-5 underline">Send Parcel</h2>
            <form onSubmit={handleSubmit(handleSendParcel)} className='mt-12 p-4 text-black'>
               ...
               <div className='p-5 text-center '>
                <button type='submit' className='btn bg-lime-300 hover:bg-lime-400'>Send Parcel</button>
               </div>
            </form>
        </div>
    );
